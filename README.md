# bsc
I will create my own bsc token but this code doesn't work
...
contract Marvel is Context, IERC20, Ownable {
    ...
    string private _name = "MARVEL";
    string private _symbol = "MRL";
    ...
    uint256 private minimumTokensBeforeSwap = 2254251 * 10**6 * 10**9; 
